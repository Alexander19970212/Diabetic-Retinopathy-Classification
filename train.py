...
from model.classifier import ClfConfig, Classifier, backbone_options
...
# def train_main():
    ...
    parser.add_argument('--output_dir', default="./Classifier2")
    ...
    parser.add_argument('--start_save_step', default=380)
    ...
    print(f'Input size for {args.backbone_name} is {backbone_options[args.backbone_name]["input_size"]}.')

    model_config = ClfConfig(backbone_name = args.backbone_name,
        num_classes = args.num_classes,
        input_size = backbone_options[args.backbone_name]['input_size'], # args.input_size,
    ...
    test_dataset, train_dataset, valid_dataset = build_datasets(args.dataset_name,
            ...
            input_size=backbone_options[args.backbone_name]['input_size'],
            input_size2=args.input_size2)
