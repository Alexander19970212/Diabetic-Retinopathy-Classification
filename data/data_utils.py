...
datasets_info = {"DDR": {"dataset_name": "DDR-dataset",
                        ...
                        #  "train_folder": "train2_05_1",
                        #   "train_folder": "train2_05_2",
                        #   "train_folder": "train3_05_1",
                        #   "train_folder": "train3_05_2",
                        #   "train_folder": "train4_034_1",
                        #   "train_folder": "train4_066_2",
                        #  "train_folder": "train5_020_1",
                        #   "train_folder": "train5_080_2",
                        #  "train_folder": "train6_080_1",
                        #   "train_folder": "train6_020_2",
                        # "train_folder": "train7_066_1",
                        # "train_folder": "train8_100_1",
                        # "train_folder": "train7_034_2",
                        "train_folder": "train9_500_1",
                        #  "train_folder": "train",
                         "mean": [0.4143788,  0.25651503, 0.12490026],
                         "std": [0.29622576, 0.20603535, 0.14079799]},
                 "APTOS": {"dataset_name": "APTOS-dataset",
                         "folder_prefix": "APTOS_grading",
                         "train_folder": "train",
                         "mean": [0.39880249, 0.21253702, 0.06773518],
                         "std": [0.28219166, 0.15496425, 0.07982969]},
                 "FGADR": {"dataset_name": "FGADR-dataset",
                         "folder_prefix": "FGADR_grading",
                         "train_folder": "train",
                         "mean": [0.45522871, 0.25797562, 0.13344749],
                         "std": [0.28158215, 0.18090164, 0.13181381]},
                 "DeepDRiD": {"dataset_name": "DeepDRiD-dataset",
                         "folder_prefix": "DeepDRiD_grading",
                         "train_folder": "train",
                         "mean": [0.43329573, 0.26706908, 0.15991962],
                         "std": [0.30578597, 0.20065437, 0.14422186]},
                 "Messidor": {"dataset_name": "Messidor-dataset",
                         "folder_prefix": "Messidor_grading",
                         "train_folder": "train",
                         "mean": [0.52340599, 0.24769837, 0.08209024],
                         "std": [0.31269603, 0.15972963, 0.0710566 ]},
                 "Messidor2": {"dataset_name": "Messidor2-dataset",
                         "folder_prefix": "Messidor2_grading",
                         "train_folder": "train",
                         "mean": [0.48192112, 0.22439515, 0.07780152],
                         "std": [0.29382361, 0.14849576, 0.06656473]},
                 "IDRiD": {"dataset_name": "IDRiD-dataset",
                         "folder_prefix": "IDRiD_grading",
                         "train_folder": "train",
                         "mean": [0.45716851, 0.2227084,  0.0728795],
                         "std": [0.30642633, 0.16467338, 0.08821591]},
...
def build_datasets(dataset_name, dataset_root_dir, input_size=224, input_size2=None):
    ...
    for subset_name in subset_names:
        ...
        print("Table 9csv ddr500 name: ", csv_name)
